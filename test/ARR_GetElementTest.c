...
int main()
{
    ARR_Instance array;
    unsigned int index;
    struct ARR_Instance_Record __aca_val_array;
    void * data = 0;
    unsigned int elem_size = __VERIFIER_nondet_uint();
    unsigned int used = __VERIFIER_nondet_uint();
    unsigned int allocated = __VERIFIER_nondet_uint();
    __aca_val_array = (struct ARR_Instance_Record) {.data = data, .elem_size = elem_size, .used = used, .allocated = allocated};
    array = &__aca_val_array;
    index = __VERIFIER_nondet_uint();
    ARR_GetElement(array, index);
}
